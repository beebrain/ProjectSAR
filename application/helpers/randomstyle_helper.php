...
function randomstyle($num = NULL) {
    ...
    if ($num == NULL) {
        ...
        return $color_array[$num % sizeof($color_array)];
    }
}

function randomIcon($num = NULL) {
    $icon_array = array_keys(ebor_icons_list());
    if ($num == NULL) {
        $icon_array = array_shuffle($icon_array);
        return $icon_array[0];
    } else {
        return $icon_array[$num];
    }
}
